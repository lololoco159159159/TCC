// Hero da Home — "Conhecimento conectado." (fiel ao protótipo final): grid de
// 2 colunas com label mono + título Spectral + parágrafo à esquerda, e os dois
// grupos de CTA (Criar conta gratuita / Entrar) separados pelo divisor "ou" à
// direita. Extraído da Home na R7b (movimento puro de JSX).
